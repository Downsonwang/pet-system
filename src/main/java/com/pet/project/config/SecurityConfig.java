...
public class SecurityConfig {
    ...
    @Autowired
    private JwtAuthFilter jwtAuthFilter;  // 需要创建这个过滤器
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**").permitAll()  // 开放 auth 接口
                        .requestMatchers("/api/appointments/**").permitAll()  // 开放 appointments 接口
